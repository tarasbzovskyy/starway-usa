/**
 * Created by t.bzovskyy on 8/9/18.
 */
...
var mouseX = mouseY = mouseOldX = mouseOldY = 0,
    ...
    speedTrailAppear = .2,
    speedTrailDisappear = .2,
    speedTriOpen = 1,
    trailMaxLength = 20,
    trailIntervalCreation = 300,
    ...
    colors = [
        //grey
        '#f5f5f5', '#ebebeb','#dbdbdb', '#eaeaea', '#f9f9f9', '#333333',
        //reds
        '#bf0a20', '#ca2539',
        //blues
        '#241a60', '#d8d7e1', '#9997ab'
    ];
